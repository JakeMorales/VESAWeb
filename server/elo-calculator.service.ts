...
export class EloCalculatorService {
  ...
  static placementWeight = 45;
  static combatWeight = 35;
  static damageWeight = 15;
  static supportWeight = 5;
   ...
   */
  static calculateEloChange(performanceScore: number): number {
