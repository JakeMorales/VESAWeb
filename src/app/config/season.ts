...
export const SIGNUPS_OPEN = new Date('2026-07-22T00:00:00-04:00');
export const SIGNUPS_CLOSE = new Date('2026-08-06T00:00:00-04:00');
...
export const SEASON_SCHEDULE: ScheduleEntry[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { date: new Date('2026-08-17T20:00:00-04:00'), divisions: 'All Divisions' },
      { date: new Date('2026-08-19T20:00:00-04:00'), divisions: 'All Divisions' },
    ],
  },
  {
    label: 'Week 1',
    ...
    slots: [
      ...
      { date: new Date('2026-08-27T20:00:00-04:00'), divisions: 'Div I & VI' },
    ],
  },
  {
    label: 'Week 2',
    ...
    slots: [
      ...
      { date: new Date('2026-09-03T20:00:00-04:00'), divisions: 'Div I & VI' },
    ],
  },
  {
    label: 'BYE Week (Labor Day)',
    type: 'break',
  ...
  },
  {
    ...
    slots: [
      ...
      { date: new Date('2026-09-17T20:00:00-04:00'), divisions: 'Div I & VI' },
    ],
  },
  {
    label: 'Week 4',
    ...
    slots: [
      ...
      { date: new Date('2026-09-24T20:00:00-04:00'), divisions: 'Div I & VI' },
    ],
  },
  {
    label: 'Week 5',
  ...
  },
  {
    ...
    type: 'match-point',
    slots: [
      { date: new Date('2026-10-12T20:00:00-04:00'), divisions: 'Div III, V & VIII' },
      { date: new Date('2026-10-14T20:00:00-04:00'), divisions: 'Div II, IV & VII' },
      { date: new Date('2026-10-15T20:00:00-04:00'), divisions: 'Div I & VI' },
    ],
  },
  {
    label: `Season ${CURRENT_SEASON} Award Show`,
    type: 'award',
    date: new Date('2026-10-17T00:00:00-04:00'),
  },
];
